...
Please note that all the codes here are meant to demonstrate part of my attempt at becoming better at the statistical concepts that I was studying at the time and at programming. In that regard, some codes contain my own experimentation/exploration of different ideas applied to a specific problem (e.g. hm2.ipynb or bayesian_core.ipynb files above).
